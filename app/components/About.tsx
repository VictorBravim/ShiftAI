  ...
  return (
    <div className="about bg-black text-white p-4">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="w-full lg:w-[25%] flex justify-center bg-dark py-32 lg:py-72 rounded-[50px]">
        ...
        <div className="w-full lg:w-[75%] flex justify-center bg-dark py-32 lg:py-72 rounded-[50px]">
      ...
      <div className="flex flex-col lg:flex-row gap-8 mt-8">
        <div className="w-full lg:w-[25%] bg-dark p-32 lg:p-40 rounded-[50px]">
